...
%%checking whether no. of individuals selected for crossover odd or even
        ...
        for i=1:2:lengthCross
            crossPoint1=randi([2,IndLength-1]);
            crossPoint2=randi([2,IndLength-1]);
            if(crossPoint1>crossPoint2)
                tempcross=crossPoint1;
                crossPoint1=crossPoint2;
                crossPoint2=tempcross;
            end
            %%select crossover point 
            temp1=SelectedPop(CrossInd(i,1),crossPoint1:crossPoint2);
            temp2=SelectedPop(CrossInd(i+1,1),crossPoint1:crossPoint2);
            
            SelectedPop(CrossInd(i,1),crossPoint1:crossPoint2)=temp2;
            SelectedPop(CrossInd(i+1,1),crossPoint1:crossPoint2)=temp1;
        end
%%%%%Flipping mutation%%%%
